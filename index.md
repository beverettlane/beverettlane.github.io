...
<head>
    ...
    <!-- deck.gl -->
    <script src="https://unpkg.com/deck.gl@^8.4.0-alpha.2/dist.min.js"></script>
    <script src="https://unpkg.com/@deck.gl/carto@^8.4.0-alpha.2/dist.min.js"></script>
...
<!-- Add legend data -->
    ...
    <div class="as-panel__element" style="max-width: 400px; padding: 10px;">
        ...
        <!-- <footer class="as-map-footer" style="max-height: 300px; padding: 10px">
...
//CREATE LAYERS AND POP-UPS
        ...
        datasets = [
            {
                ...
                tableColumns: ['title', 'subtitle', 'link', 'location'],
                tableData: []
            },
            {
    ...
    function addLayer(dataset, checkboxID, iconURL) {
        ...
        if (pickingInfo.picked) {
            ...
            switch (pickingInfo.layer.id) {
                ...
                case 'spanish_frequencies_layer':
                    htmlTooltip += getHtmlTooltip("#EDAE49", 
                                                  pickingInfo.object.properties.station,
                                                  "Frequency: " + pickingInfo.object.properties.frequency,
                                                  [
                                                      { label: "", value: "Station website", link: pickingInfo.object.properties.homepage},
